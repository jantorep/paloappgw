...
param resourceId_Microsoft_Network_publicIPAddresses_variables_fw1_interface0_pip_name string
...
param resourceId_Microsoft_Network_publicIPAddresses_variables_fw1_interface1_pip_name string
param resourceId_variables_internalLb_resource_group_Microsoft_Network_loadBalancers_variables_internalLb_name string
param resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface0_name string
param resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface1_name string
param resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface2_name string
...
param variables_fw1_interface0_pip_name ? /* TODO: fill in correct type */
...
param variables_fw1_interface1_pip_name ? /* TODO: fill in correct type */
param variables_fw1_interface0_name ? /* TODO: fill in correct type */
param variables_fw1_interface0_ip ? /* TODO: fill in correct type */
param variables_fw1_interface0_pip_id ? /* TODO: fill in correct type */
...
param variables_fw1_interface1_name ? /* TODO: fill in correct type */
param variables_fw1_interface1_ip ? /* TODO: fill in correct type */
param variables_fw1_interface1_pip_id ? /* TODO: fill in correct type */
...
param variables_fw1_interface2_name ? /* TODO: fill in correct type */
param variables_fw1_interface2_ip ? /* TODO: fill in correct type */
...
param variables_fw1_computerName ? /* TODO: fill in correct type */
...
resource variables_fw1_interface0_pip_name_resource 'Microsoft.Network/publicIPAddresses@[parameters(\'variables_global_var_apiVersion\')]' = if (variables_global_fw_interface0_pip_option == 'Yes') {
  sku: {
    name: variables_global_var_sku
    tier: variables_global_var_tier
  }
  name: variables_fw1_interface0_pip_name
...
resource variables_fw1_interface1_pip_name_resource 'Microsoft.Network/publicIPAddresses@[parameters(\'variables_global_var_apiVersion\')]' = if (variables_global_fw_interface1_pip_option == 'Yes') {
  sku: {
    name: variables_global_var_sku
    tier: variables_global_var_tier
  }
  name: variables_fw1_interface1_pip_name
  location: resourceGroup().location
  properties: {
    publicIPAddressVersion: variables_global_var_networkVersion
    publicIPAllocationMethod: variables_global_var_allocationMethod
...
resource variables_fw1_interface0_name_resource 'Microsoft.Network/networkInterfaces@[parameters(\'variables_global_var_apiVersion\')]' = {
  name: variables_fw1_interface0_name
  location: resourceGroup().location
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        properties: {
          privateIpAddress: variables_fw1_interface0_ip
          privateIPAllocationMethod: variables_global_var_allocationMethod
          publicIpAddress: ((variables_global_fw_interface0_pip_option == 'Yes') ? variables_fw1_interface0_pip_id : json('null'))
          subnet: {
  ...
  dependsOn: [
    resourceId_Microsoft_Network_publicIPAddresses_variables_fw1_interface0_pip_name
  ]
}

resource variables_fw1_interface1_name_resource 'Microsoft.Network/networkInterfaces@[parameters(\'variables_global_var_apiVersion\')]' = {
  name: variables_fw1_interface1_name
  location: resourceGroup().location
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        properties: {
          privateIpAddress: variables_fw1_interface1_ip
          privateIPAllocationMethod: variables_global_var_allocationMethod
          publicIpAddress: ((variables_global_fw_interface1_pip_option == 'Yes') ? variables_fw1_interface1_pip_id : json('null'))
          subnet: {
  ...
  dependsOn: [
    resourceId_Microsoft_Network_publicIPAddresses_variables_fw1_interface1_pip_name
  ]
}

resource variables_fw1_interface2_name_resource 'Microsoft.Network/networkInterfaces@[parameters(\'variables_global_var_apiVersion\')]' = {
  name: variables_fw1_interface2_name
  location: resourceGroup().location
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        properties: {
          privateIpAddress: variables_fw1_interface2_ip
          privateIPAllocationMethod: variables_global_var_allocationMethod
          subnet: {
...
resource variables_fw1_computer 'Microsoft.Compute/virtualMachines@[parameters(\'variables_global_var_apiVersion\')]' = {
  name: variables_fw1_computerName
  location: resourceGroup().location
  plan: {
  ...
  properties: {
    ...
    osProfile: {
      computerName: variables_fw1_computerName
    ...
    networkProfile: {
      networkInterfaces: [
        {
          id: resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface0_name
          properties: {
            primary: true
          }
        }
        {
          id: resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface1_name
          properties: {
            primary: false
          }
        }
        {
          id: resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface2_name
          properties: {
            primary: false
          }
        }
  ...
  dependsOn: [
    resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface0_name
    resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface1_name
    resourceId_Microsoft_Network_networkInterfaces_variables_fw1_interface2_name
  ]
}